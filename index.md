...
directly, which already provide full aesthetic flexibility (fill, alpha,
colour, linewidth, …) with no package-specific code needed.
...
filtering the bundled anatomy data.
...
system and the
[`ggplot2::geom_map()`](https://ggplot2.tidyverse.org/reference/geom_map.html)
power-user path for mapping more than one aesthetic at once.
...
`dev/NOTES.md` for the full build history and attribution/licensing
details.
